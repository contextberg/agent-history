...
export interface KnowledgeConfig {
  ...
  */
  watchedRepos?: string[];
  /**
   * Repo paths the user explicitly removed from automatic memory targeting.
   * These prevent the "current repo" / "By commit" auto-add behaviour from
   * bringing a repo back on the next launch.
   */
  ignoredRepos?: string[];
}
