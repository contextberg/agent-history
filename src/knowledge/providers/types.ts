 ...
 *   oauth_disk    — token read from an app-owned file on disk
 */
 ...
 * known credential file is found on disk.
 */
...
export interface ResolvedAuth {
  ...
  /** Source label for diagnostics ("env:OPENAI_API_KEY", "disk:~/.agent-history/codex-auth.json"). */
  source: string;
}
