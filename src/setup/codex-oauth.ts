...
/**
 * Codex device-code OAuth flow — port of reference/hermes_cli/auth.py:_codex_device_code_login.
 *
 ...
 * still READ from ~/.codex/auth.json when present (detectAuth does that),
 * but writes go to our own location.
 */
